...
#slide[
  ...
  #text(fill:SECONDARY_COLOR, size: 80pt, weight: "black")[Modules #uncover("2-")[are namespaces]]
]
  #v(-1em)
  #one-by-one(start:3)[
...
#slide(title: "Thinking in modules")[
  ...
  For example, use a *module* for:
    ...
    #align(center, text(fill: PRIMARY_COLOR, size: 30pt, weight: "black")[A module is a way to reuse code])
]
